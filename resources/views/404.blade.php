...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="/purple/images/favicon.png" />
  </head>
  <body>
            ...
            <div class="col-lg-7 mx-auto text-white">
              <div class="row align-items-center d-flex flex-row">
                ...
                <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                  <h2>SORRY!</h2>
                  <h4 class="font-weight-light">The page you’re looking for was not found.</h4>
                  <br>
                  <h3 class="font-weight-light">Make sure your url is correct and valid</h2>
                </div>
              </div>

              <div class="row mt-5">
                <div class="col-12 mt-xl-2">
                   <a class="text-white font-weight-medium" href="/admin">Back to Commjuction</a>
                </div>
              </div>
            </div>
          </div>
