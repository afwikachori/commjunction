...
<body id="supportpal_subscriber">
    @if (Session::has('session_subscriber_logged'))
    <div class="wrapper sidebar_minimize">
        <div class="main-header">
            @include('subscriber.supportpal.layouts.header')
        </div>
        ...
        <div class="main-panel">
            ...
            <footer class="footer">
                @include('subscriber.supportpal.layouts.footer')
            </footer>
        </div>
    ...
    @else
        ...
        ?>
            <script>window.location = "{{$url_loginsubs}}";</script>
