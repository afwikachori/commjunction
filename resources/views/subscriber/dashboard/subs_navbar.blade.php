    ...
    <ul class="navbar-nav navbar-nav-right">
        <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                <a class="dropdown-item" data-toggle="modal" data-target="#modal_profile_management">
                    <i class="mdi mdi mdi-brush mr-2 text-primary"></i>
                    <div lang="en">Profile Management</div>
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" data-toggle="modal" data-target="#modal_logout_subscriber"
                    data-dismiss="modal">
                    <i class="mdi mdi-logout mr-2 text-primary"></i>
                    <div lang="en">Logout</div>
                </a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                ...
                <div class="dropdown-divider"></div>
                <a href="/subscriber/notification_management">
                    <h6 class="p-3 mb-0 text-center" lang="en" data-lang-token="See all notifications">See all
                        notifications</h6>
                </a>
            </div>
        </li>
