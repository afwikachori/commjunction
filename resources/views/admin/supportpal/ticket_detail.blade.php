                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 kananin">
                            <a href="/admin/supportpal/ticket/ticket-update/{{$dataDetail['id']}}/1" class="btn btn-sm btn-success"
                                type="button">
                                 <i class="fas fa-check-square"></i> &nbsp;
                                Open Ticket
                            </a>

                            <a href="/admin/supportpal/ticket/ticket-update/{{$dataDetail['id']}}/2" class="btn btn-sm btn-danger"
                                type="button">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="comment-form">
                        ...
                        <form method="post" action="{{route('post.message.create.admin')}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" value="{{$dataDetail['id']}}" name="ticket_id">
                            <input type="hidden" id="user_id_komen_admin" name="user_id">
