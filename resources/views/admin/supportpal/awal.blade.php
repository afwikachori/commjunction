            ...
            <div class="card card-stats card-round">
                <div class="card-body bg-menus">
                    <div class="row align-items-center">
                        <div class="col-icon">
                            <a href="/admin/supportpal/ticket" class="menus-link">
                        ...
                        <div class="col col-stats ml-3 ml-sm-0">
                            <div class="numbers">
                                <h1 class="mb-1 menus-link"><b><a href="/admin/supportpal/ticket" class="menus-link"> Ticket </a></b>
                                </h1>
        ...
        <div class="col-sm-6 col-md-6">
            <div class="card card-stats card-round">
                <div class="card-body bg-menus">
                    <div class="row align-items-center">
                        <div class="col-icon">
                            <a href="/admin/supportpal/article" class="menus-link">
                        ...
                        <div class="col col-stats ml-3 ml-sm-0">
                            <div class="numbers">
                                <h1 class="mb-1 menus-link"><b><a href="/admin/supportpal/article" class="menus-link">Articles </a></b>
                                </h1>
