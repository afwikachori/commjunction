...
<div class="row">
    <div class="col orenq">
        ...
        <center>
            <h5 class="putih" lang="en" style="margin-left: 1.5em; margin-right: 1.5em; margin-top: 6em;">Some detailed
                information your community needs</h5>
        </center>
    </div>
    <div class="col-8">
        <div class="row">
        ...
        <div class="pdregis1">
            ...
            <form method="POST" id="form_registersecond_admin" action="{{route('registersecond')}}"
                class="kontenregsiter mgtop-1" style="margin-bottom: 2em;">{{ csrf_field() }}
                    ...
                    <div class="row" style="margin-top: 0.3em;">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group row">
                                ...
                                <input id="username_admin" type="text"
                            ...
                            <div class="form-group row">
                                ...
                                <input id="email_admin" type="email"
                                    class="form-control @error('email') is-invalid @enderror" name="email_admin"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="password_admin" type="password"
                                        value="{{ old('password_admin') }}"
                                        class="form-control @error('password_admin') is-invalid @enderror"
                                        name="password_admin" required autocomplete="password_admin"
                                        aria-describedby="btn_showpass">
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-light" type="button" id="btn_showpass"
                                            onclick="showPass()" style="border-color: #ced4da;">
        ...
        <input type="hidden" id="sso_token" name="sso_token">
                            ...
                            <div class="form-group row">
                                ...
                                <input id="phone_admin" type="text"
                    ...
                    <div class="row" style="margin-bottom: -0.5em; margin-top: 1em;">
                        <button type="button" onclick="location.href='/admin/register';" class="btn backbtn"
                            lang="en">Back</button>
                        &nbsp;&nbsp;&nbsp;
