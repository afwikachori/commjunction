    ...
    <div class="col-md">
        <div class="card" style="min-height: 485px;">
            ...
            <div class="card-footer putih" style="text-align: right; margin-bottom: 1em;">
                <button type="button" onclick="give_approval('{{$user_id }}');"
                    class="btn btn-sm btn-teal">Approval</button>
            </div>
        </div>
    </div>


    <div class="col-sm-4 col-activity" style="display: none;">
        <div class="card" style="min-height: 485px;">
            <div class="card-header putih">
                <div class="row">
...
<!-- MODAL APPROVAL -->
<div class="modal fade" id="modal_approval_pendingsubs" data-backdrop="static" tabindex="-1" role="dialog"
            ...
            <form method="POST" id="form_acc_pending_subs" action="{{route('approval_pending_subs')}}">
                ...
                <div class="modal-body" style="margin-top: -1.5em;">
                    ...
                    <div class="form-group" style="margin-top: 1em;">
                        ...
                        <textarea class="form-control input-abu" id="alasan_approv" name="alasan_approv"
                            rows="5"></textarea>
                    </div>

                </div> <!-- end-modal body -->
                <div class="modal-footer"
                    style="border: none; margin-top: 1em; text-align: center; padding-right: 25%; padding-bottom: 5%;">
