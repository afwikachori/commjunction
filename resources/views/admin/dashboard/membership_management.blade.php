...
<div class="modal fade" id="modal_detail_pay_membership" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="modal-header" style="padding-bottom: 0em !important;">
    ...
    <button type="button" id="btn_paymentmember_confirm" class="btn btn-tosca btn-sm" style="margin-bottom: 1em;" data-toggle="modal" data-target="#modal_confirm_membership" data-dismiss="modal">Payment Confirm</button>
</div> <!-- end-header -->
...
<div class="modal fade" id="modal_confirm_membership" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background-color: #ffffff;">
...
<form method="POST" id="form_acc_req_membership" action="{{route('approval_req_membership')}}" enctype="multipart/form-data">
{{ csrf_field() }}
...
<center>
   ...
   <div class="up_acc_file">
    <img id="view_img_member" class="profile-pic img-fluid accmember" onclick="clickImage(this)"  src="">
...
<a class="btn btn-outline-light" type="button" id="btn_showpass_accmember" onclick="showPassText('acc_password')">
  ...
  <div class="modal-footer" style="border: none;padding-right: 30%; padding-bottom:5%; padding-top: 0px;">
    ...
    <center>
    <button type="submit" name="action" value="reject" class="btn btn-light btn-sm" style="border-radius: 10px;">
      <i class="mdi mdi-close"></i> Reject
    </button>
    &nbsp;
    <button type="submit" name="action" value="approve" id="btn_acc_membership" class="btn btn-teal btn-sm melengkung10px">
    <i class="mdi mdi-check btn-icon-prepend">
        </i> Approve </button>
    </center>
