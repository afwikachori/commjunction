...
<div class="row">
    ...
    <div class="col-md-5">
        <label class="cgrey" lang="en">Manage your Transaction information<label>
    </div>
</div>
<br>
    ...
    <div class="row">
        <div id="page_transaction_management_admin"></div>
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                                ...
                                <div class="col-md-10">
                                    <h4 class="mb-0">
                                        <a data-toggle="collapse" href="#collapseOne" role="button"
                                            ...
                                            style="color:#0e6f73;" lang="en" data-lang-token="Choose Parameter First">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <button type="button" id="btn_filter_trans" class="btn btn-tosca btn-sm"
                                    ...
                                    data-target="#modal_trasaksi_filter" data-dismiss="modal" lang="en">Filter</button>
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12" style="border-right: 1px solid #E0E0E0; height: 100%;">
                            ...
                            <div class="footer_mdl" style="text-align: right; margin-top: 22%;">
                                ...
                                <button type="button" class="btn btn-teal btn-sm" id="btn_download_detail"
                                    ...
                                    <span class="en">Download</span></button>
                            </div>
                        </div>
